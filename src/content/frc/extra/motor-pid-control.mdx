...
Running PID on the motor controller (1kHz loop) is faster and smoother than on the RIO (50Hz). It frees up CAN bus bandwidth and RIO CPU.

### PID Slots

Controllers have 'Slots' (0, 1, 2...) to store different PID gains. Example: Slot 0 for Position, Slot 1 for Velocity.
...
<LinkGrid links={[{"label":"Trapezoidal Motion Profiling","id":"trapezoidal-motion-profiling"},{"label":"PID Overview","id":"frc-pid-control"}]} title="Resources" section="frc" />
